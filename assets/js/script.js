...
function getRecipes() {
  ...
  var requestURL =
    ...
    "&app_key=" +
    edamamApiKey +
    "&mealType=dinner&ishType=Desserts&dishType=Main%20course&dishType=Starter&imageSize=REGULAR" +
    excludeItems +
    "&random=true&field=uri&field=label&field=image&field=source&field=ingredientLines&field=ingredients&field=url";
            ...
            .then(function (data3) {
              ...
              $("#first-link").attr(
                ...
                "https://www.thecocktaildb.com/drink/" +
                  drinkResults[0].drinks[0].idDrink
              );
              $("#first-image").attr(
                "src",
                drinkResults[0].drinks[0].strDrinkThumb
              );
              ...
              $("#second-link").attr(
                "href",
                "https://www.thecocktaildb.com/drink/" +
                  drinkResults[1].drinks[0].idDrink
              );
              $("#second-image").attr(
                "src",
                drinkResults[1].drinks[0].strDrinkThumb
              );
              ...
              $("#third-link").attr(
                "href",
                "https://www.thecocktaildb.com/drink/" +
                  drinkResults[2].drinks[0].idDrink
              );
              $("#third-image").attr(
                "src",
                drinkResults[2].drinks[0].strDrinkThumb
              );
              ...
              $("#fourth-link").attr(
                "href",
                "https://www.thecocktaildb.com/drink/" +
                  drinkResults[3].drinks[0].idDrink
              );
              $("#fourth-image").attr(
                "src",
                drinkResults[3].drinks[0].strDrinkThumb
              );
              ...
              $("#fifth-link").attr(
                "href",
                "https://www.thecocktaildb.com/drink/" +
                  drinkResults[4].drinks[0].idDrink
              );
              $("#fifth-image").attr(
                "src",
                drinkResults[4].drinks[0].strDrinkThumb
              );
              ...
              $("#sixth-link").attr(
                "href",
                "https://www.thecocktaildb.com/drink/" +
                  drinkResults[5].drinks[0].idDrink
              );
              $("#sixth-image").attr(
                "src",
                drinkResults[5].drinks[0].strDrinkThumb
              );
              ...
              for (var i = 1; i < 15; i++) {
                if (
                  drinkResults[0].drinks[0]["strIngredient" + i] !== null &&
                  drinkResults[0].drinks[0]["strIngredient" + i] !== ""
                ) {
              ...
              for (var i = 1; i < 15; i++) {
                if (
                  drinkResults[1].drinks[0]["strIngredient" + i] !== null &&
                  drinkResults[1].drinks[0]["strIngredient" + i] !== ""
                ) {
                  var eachDrinkIngredient =
                    drinkResults[1].drinks[0]["strIngredient" + i];
                  var listedDrinkIngredients = document.createElement("li");
              ...
              for (var i = 1; i < 15; i++) {
                if (
                  drinkResults[2].drinks[0]["strIngredient" + i] !== null &&
                  drinkResults[2].drinks[0]["strIngredient" + i] !== ""
                ) {
                  var eachDrinkIngredient =
                    drinkResults[2].drinks[0]["strIngredient" + i];
                  var listedDrinkIngredients = document.createElement("li");
              ...
              for (var i = 1; i < 15; i++) {
                if (
                  drinkResults[3].drinks[0]["strIngredient" + i] !== null &&
                  drinkResults[3].drinks[0]["strIngredient" + i] !== ""
                ) {
                  var eachDrinkIngredient =
                    drinkResults[3].drinks[0]["strIngredient" + i];
                  var listedDrinkIngredients = document.createElement("li");
              ...
              for (var i = 1; i < 15; i++) {
                if (
                  drinkResults[4].drinks[0]["strIngredient" + i] !== null &&
                  drinkResults[4].drinks[0]["strIngredient" + i] !== ""
                ) {
                  var eachDrinkIngredient =
                    drinkResults[4].drinks[0]["strIngredient" + i];
                  var listedDrinkIngredients = document.createElement("li");
              ...
              for (var i = 1; i < 15; i++) {
                if (
                  drinkResults[5].drinks[0]["strIngredient" + i] !== null &&
                  drinkResults[5].drinks[0]["strIngredient" + i] !== ""
                ) {
                  var eachDrinkIngredient =
                    drinkResults[5].drinks[0]["strIngredient" + i];
                  var listedDrinkIngredients = document.createElement("li");
